...
const ProductCard = ({product}) => {
    ...
    return product && (
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-50 max-w-30 w-full">
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                        <img key = {i} className='md:2-3.5 w-3' src={i < 4 ? assets.star_icon : assets.star_dull_icon} alt=''/>
                    ))}
                    <p>(4)</p>
                </div>
                <div className="flex items-end justify-between mt-3">
                    ...
                    {/* Stops the click event from traveling to parent elements */}
