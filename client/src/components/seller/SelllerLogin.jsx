...
const SelllerLogin = () => {
  ...
  const onSubmitHandler = async (event) => {
    try {
      ...
      //we have to make the API call for the seller login.
      // {data} : we will get this data in response
...
//   This will display when isSeller is false means seller is not logged in 
  return !isSeller && (
