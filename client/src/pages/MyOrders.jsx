...
const MyOrders = () => {
    ...
    //whenever components get loaded, it should execute fetchMyOrders  
    useEffect(() => {
        if(user){
            fetchMyOrders()
        }
    ...
    <div className='mt-16 pb-16'>
        ...
        <div className='flex flex-col items-end w-max mb-8'>
            ...
            <div className='w-16 h-0.5 bg-primary rounded-full'></div>
                     ...
                     {/* Loop through all orders and render order details dynamically */}
                ...
                <div key = {index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl'>
                    <p className='flex justify-between md:items-center text-gray-400 md:font-medium max-md:flex-col'>
                        ...
                        {/* Display payment method used for this order */}
                        <span>Payment : {order.paymentType} </span>

                         {/* Display total order amount with currency */}
