...
const AddAddress = () => {
  ...
  const {axios, user, navigate} = useAppContext()
    ...
    const handleChange = (e) => {
        ...
        // Extracts name and value from input,
        const {name, value } = e.target;

        setAddress((prevAddress) => ({

            // spreads previous address state,
            ...prevAddress,

            // and updates only the changed field using computed property name
            [name] : value,
        }))
    }
    ...
    <div className='mt-16 pb-16'>
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
        <div className='flex-1 max-w-md'>
            <form className='space-y-3 mt-3 text-sm'
            onSubmit={onSubmitHandler}>
               
                <div className='grid grid-cols-2 gap-4 mt-0'>
                      {/* handleChange updates address state dynamically */}
